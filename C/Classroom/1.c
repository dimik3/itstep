...
void addTransaction(struct Menu* const transations,
...
void printTransactions(struct Menu* const transations,
...
void main()
{
	struct Menu* transations =
		calloc(50, sizeof(struct Menu));
